...
CoreAnimation是一套图像渲染和动画基础框架。

![image-20200811205504830](/Users/zhaojiaqi/Library/Application Support/typora-user-images/image-20200811205504830.png)

看这张图我们可以知道，它是UIKit和AppKit的底层实现，位于Metal和Core Graphics之上。
...
![image-20200812181227489](/Users/zhaojiaqi/Library/Application Support/typora-user-images/image-20200812181227489.png)
...
工厂模式、观察者模式、中介者模式、单利模式。这个根据实际情况说吧。
